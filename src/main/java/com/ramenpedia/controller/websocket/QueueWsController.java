...
public class QueueWsController extends BaseController {
    ...
    @SendTo("/topic/queue-ws/{storeId}")
    public ApiResponse<BusinessHoursSend> businessHours(@DestinationVariable("storeId") Long storeId, BusinessHoursMessage message,
    ...
    @SendTo("/topic/queue-ws/{storeId}")
    public ApiResponse<QueueSend> queue(@DestinationVariable("storeId") Long storeId, QueueMessage message,
                                        JwtAuthenticationToken jwtToken) throws Exception {
    ...
    @SendTo("/topic/queue-ws/{storeId}")
    public ApiResponse<LimitedSend> limited(@DestinationVariable("storeId") Long storeId, LimitedMessage message,
                                            JwtAuthenticationToken jwtToken) throws Exception {
